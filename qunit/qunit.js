...
QUnit = {
	...
	test: function( testName, expected, callback, async ) {
		...
		if ( defined.htmlService ) {
			...
			testTemplate.testName = nameHtml;
		}
	...
	start: function( count ) {
		...
		if ( !defined.htmlService && config.semaphore === undefined ) {
...
extend( QUnit, {
	...
	url: function( params ) {
		...
		return defined.htmlService ? ScriptApp.getService().getUrl() : window.location.protocol + "//" + window.location.host +
